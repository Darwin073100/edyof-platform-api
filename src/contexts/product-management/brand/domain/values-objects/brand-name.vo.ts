...
import { InvalidBrandException } from "../exceptions/invalid-brand.exception";
 ...
 */
export class BrandNameVO extends ValueObject<BrandNameProps> {
  ...
  public static create(name: string): BrandNameVO {
    ...
    return new BrandNameVO({ value:name });
  }
